$(function () {
  ...
  function setup() {
    ...
    createCollectable("grace", 50, 290, 20, 0);
    createCollectable("max", 700, 400, 20, 0.5)
    ...
    createCannon("left", 685, 3000);
    // Last Platform Cannons //
   createCannon("right", 625, 2000)
   createCannon("right", 525, 25000)
